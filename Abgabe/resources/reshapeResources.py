...
resourcePath = os.getcwd() + "/objects/"
reshapedPath = os.getcwd() + "/objects_reshaped_png/"
centeredPath = os.getcwd() + "/objects_centered_png/"
reshapedBWPath = os.getcwd() + "/objects_reshaped_jpeg/"
centeredBWPath = os.getcwd() + "/objects_centered_jpeg/"
